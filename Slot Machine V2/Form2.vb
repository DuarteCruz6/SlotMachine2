...
Public Class Form2
    ...
    Private Sub bttOk_Click(sender As Object, e As EventArgs) Handles bttOk.Click
        ...
        ElseIf i = 3 Then
            ...
            pct1.Image = Image.FromFile(path & "7.png")
            i += 1

        ElseIf i = 4 Then
            lblRegras.Text = "Caso consiga dois 7, irá ganhar 2000 créditos."
            pct1.Image = Image.FromFile(path & "7.png")
            pct2.Image = Image.FromFile(path & "7.png")
            i += 1
        ...
        ElseIf i = 5 Then
            ...
            pct1.Image = Image.FromFile(path & "7.png")
            pct2.Image = Image.FromFile(path & "7.png")
            pct3.Image = Image.FromFile(path & "7.png")
            i += 1
        ...
        ElseIf i = 9 Then
            lblRegras.Text = "No entanto, pode adicionar créditos através do botão destinado a tal."
            bttCrd.Visible = True
            i += 1
        ...
        ElseIf i = 11 Then
            menu.Visible = True
            lblRegras.Text = "Por fim, tem também um menu com os botões ´Jogar´, ´Sair´, ´Adicionar Créditos´, ´Ajuda´ e ´Índice´, que poderá aceder a qualquer momento."
            i += 1
        Else
            bttOk.Visible = False
